// My Public API - ced3d6972bd16da026d37c07b02a9f83
// MD5 Hash -  df5c0bb7703e7d5211513f061abc1d79
...
//  If search query matches the results then it will execute next function/command.
    if(!searchQuery){
        ...
        return "http://gateway.marvel.com/v1/public/comics?ts=1&apikey=ced3d6972bd16da026d37c07b02a9f83&hash=df5c0bb7703e7d5211513f061abc1d79"
    }else{
        return `https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${searchQuery}&apikey=ced3d6972bd16da026d37c07b02a9f83&hash=df5c0bb7703e7d5211513f061abc1d79&ts=1`
    }
}
